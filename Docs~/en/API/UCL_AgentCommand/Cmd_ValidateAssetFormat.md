...
```bash
python CardGame/Assets/UCL/UCL_Core/Tools~/AgentCommands/run_cmd.py run ValidateAssetFormat     --arg assetType=RCG_ItemData --arg assetId=ManaCore_Shard --arg checkRefs=1
```
