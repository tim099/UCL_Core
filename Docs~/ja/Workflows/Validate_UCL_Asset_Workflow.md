...
```bash
senate ucmd run ValidateAssetFormat     --arg assetType=<C# Type> --arg assetId=<ID> --arg checkRefs=1     --output-file CardGame/AgentCommands/asset_format_check_<Type>_<ID>.md
```
