...
## 📌 記憶到底放什麼 —— 一個例子勝過三條判準（Tim 2026-08-25）
...
> | **進度**（做到哪、卡在哪） | **單子**（時間線） |
> | **完整規格／欄位表／怎麼用** | **文件** |
> | 🎯 **注意事項**（做這一段要小心什麼、哪裡會咬人、為什麼當初不那樣做） | **記憶** |

⇒ **記憶＝「不適合進單子、也不適合進文件」的那一格。**
它不是第四份進度表，也不是文件的草稿 —— 它是**做過的人才知道、而下一個人一定會撞到的那些細節**。

### 判準（照這個順序問）

1. **它是「到哪了」嗎？** ⇒ 單子。進度、順序、誰在做、什麼算完成。
2. **它是「怎麼用」嗎？** ⇒ 文件。規格、欄位、API、步驟。
3. **它是「要小心什麼 / 為什麼是這樣」嗎？** ⇒ **記憶。**
