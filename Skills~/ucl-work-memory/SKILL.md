...
last_updated: "2026-09-08 v1.5 (晚安分流：工作相關內容一律透過 work-memory 保存，晚安信專注心得感想，Tim 2026-09-08 拍板)"
---
...
> **「工作相關內容一律透過工作記憶保存，晚安信則留給當天的心得與感想，兩者不混淆。」**
> **「記憶是工作期間的鷹架不是永久資產，相關 Task 全完成後歸檔或刪除，紀錄留 git。」**
> **「歸檔不等於失聯：archived 主題仍有 commit 歷史錨點，絕不靜默消失。」**

---

## 📌 記憶到底放什麼 —— 一個例子勝過三條判準（Tim 2026-08-25 / 2026-09-08）

> 工作內容是**寫存檔系統**。大致框架已完成，後續實作順序也規劃好了。收工時：
>
> | 東西 | 去哪 |
> |---|---|
> | **施工順序**（先做 A 再做 B，第三步要等 C） | **單子**（驗收細項／留言） |
> | **進度**（做到哪、卡在哪） | **單子**（時間線） |
> | **完整規格／欄位表／怎麼用** | **文件** |
> | 🎯 **工作相關內容 / 注意事項**（架構決策、踩坑、knowhow、做這一段要小心什麼） | **工作記憶 (`ucl-work-memory`)** |
> | 💭 **個人心得、感受、哲學思考、當天感想** | **晚安信 (`ucl-goodnight` / `ucl-letters-to-self`)** |

⇒ **工作內容進記憶，心得感想進晚安信。**
工作記憶不是第四份進度表，也不是文件的草稿 —— 它是**做過的人才知道、而下一個人一定會撞到的那些細節**。
工作內容一律透過 `ucl-work-memory` 保存，晚安信則專注於當天心得感想與心境校正，不寫工作流水帳。

### 判準（照這個順序問）

1. **它是「到哪了」嗎？** ⇒ 單子。進度、順序、誰在做、什麼算完成。
2. **它是「怎麼用」嗎？** ⇒ 文件。規格、欄位、API、步驟。
3. **它是「要小心什麼 / 為什麼是這樣 / 工作踩坑」嗎？** ⇒ **工作記憶。**
4. **它是「今天的心得感想 / 主觀感受 / 哲學反思」嗎？** ⇒ **晚安信。**

⚠ 而第 3 格還要再過一關：**「換人接手需要知道嗎？」**
只有我自己需要被打臉的拖延 ⇒ 個人見叢，不是這裡。

⚠ **記憶不是每張單都要有。** Tim 2026-08-25：
> 記憶側原本就不需要每張單都有 —— **只有跨日單會需要**，甚至也不一定要。

⇒ 一張當天開當天關的單，**不需要記憶主題**。硬綁只會多一個要維護的空殼。
