    ...
    public static partial class UCL_CodeLocalize
    {
        static public string Get_ja(string iKey)
        {
            return iKey switch
            {
                ...
                "LibraryManage.BookNotes.HeaderFmt" => "📒 読書ノート BookNotes（{0} 冊）",
                "LibraryManage.BookNotes.EmptyFmt" => "（ノートがありません — BookNotes フォルダ: {0}）",
                "LibraryManage.BookNotes.SelectLabel" => "ノートを選択",
                "LibraryManage.Detail.HasFullText" => "📚 全文あり",
                "LibraryManage.Detail.NotesOnly" => "📒 ノートのみ（Books/に全文なし）",
                "LibraryManage.Detail.AuthorFmt" => "著者: {0}",
                "LibraryManage.Detail.DonatedFmt" => "📖 寄贈者: {0}（{1} token, {2}）",
                "LibraryManage.Detail.VolumesLabel" => "📕 巻数（{0}）",
                "LibraryManage.Detail.ArcsLabel" => "🌿 アーク概要 arc（{0}）",
                "LibraryManage.Detail.ReviewsLabel" => "⭐ 書評（{0}）",
                "LibraryManage.Detail.CharactersLabel" => "👥 登場人物（{0}）",
                "LibraryManage.Books.StatusFmt" => "状態: {0}",
                "LibraryManage.Books.ProgressFmt" => "進捗: 第 {0} 章 ({1})",
                "LibraryManage.Books.ReaderFmt" => "読者: {0}",
                "LibraryManage.Books.CountsFmt" => "人物 {0} ｜ arc {1} ｜ 巻 {2} ｜ 書評 {3}",
                "LibraryManage.Btn.ShowBook" => "👁 概要",
                "LibraryManage.Btn.Resume" => "▶ 続きを読む",
                ...
                "LibraryManage.Btn.Arcs" => "🌿 アーク概要",
                "LibraryManage.Btn.Terms" => "📖 用語",
                "LibraryManage.Btn.Volumes" => "📕 巻",
                ...
                "LibraryManage.AddBook.Title" => "➕ 書籍追加 (add-book)",
                "LibraryManage.Field.Id" => "id (slug)",
                "LibraryManage.Field.Title" => "タイトル",
                "LibraryManage.Field.TitleOriginal" => "原題",
                "LibraryManage.Field.Author" => "著者",
                "LibraryManage.Field.ReaderPersona" => "読者 persona",
                "LibraryManage.Btn.AddBook" => "➕ 追加",
                "LibraryManage.AddBook.Hint" => "id / タイトル / 著者は必須ですわ。原題、読者 persona は任意。追加後は上の Refresh を押しなさい！",
                ...
                "LibraryManage.Bookmark.Title" => "🔖 しおり (bookmark — どこまで読んだか + 感想)",
                "LibraryManage.Field.Chapter" => "章",
                "LibraryManage.Field.BookmarkNote" => "感想メモ",
                "LibraryManage.Btn.Bookmark" => "🔖 しおりを挟む",
