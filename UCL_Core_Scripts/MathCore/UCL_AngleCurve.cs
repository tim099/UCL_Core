...
{        
    ...
    public class UCL_AngleCurve : UCL_Path
    {
        public List<Vector3> m_Points;
        [UnityEditor.MenuItem("GameObject/3D Object/UCL/AngleCurve")]
        private static void CreateAngleCurve()
        {
            UnityEngine.Object aSelectedObject = UnityEditor.Selection.activeObject;
            ...
            var aCurve = Core.GameObjectLib.Create<UCL.Core.MathLib.UCL_AngleCurve>("UCL_AngleCurve", aParent);
