...
{
    /// <summary>
    /// Copy of HorizontalOrVerticalLayoutGroup and add some new feature
    /// Add m_IsInverse flag to inverse the child order
    /// </summary>
    public abstract class UCL_HorizontalOrVerticalLayoutGroup : UnityEngine.UI.LayoutGroup
    {
        /// <summary>
        /// UCL New feature!!
        /// </summary>
        ...
        protected void CalcAlongAxis(int axis, bool isVertical)
        {
            ...
            {
                int aAt = m_IsInverse? rectChildren.Count-i-1 :  i;

                RectTransform child = rectChildren[aAt];
